            ...
            <Grid container spacing={0}>
                ...
                <Grid item xs={7}>
                    ...
                    <div className="NormalPageLayoutLeft ScrollingBox">
                        ...
                        <p>
                            <b className="AbilityHeaderSmall moveRight0">Skill Points & Max Skill Tree Level:</b>
                            ...
                            <p />
                            <b className="AbilityHeaderSmall moveRight0">Spending Skill Points:</b>
                            ...
                            <p />
                            <b className="AbilityHeaderSmall moveRight0">Attribute Points:</b>
